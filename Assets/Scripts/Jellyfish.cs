...
{
    public AudioClip[] JellyfishArray;
    ...
    void PlayRandom()
    {
        ...
        clipIndex = Random.Range(0, JellyfishArray.Length);
        effectSource.pitch = pitch;
        effectSource.PlayOneShot(JellyfishArray[clipIndex], vol);
    ...
    {
        //play in sequence
        if (clipIndex == JellyfishArray.Length)
        {
            clipIndex = 0;
        }
        //else
        //{
        //}
        effectSource.PlayOneShot(JellyfishArray[clipIndex]);
        clipIndex++;
    }
